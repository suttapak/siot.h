...
const char *SERVER_HOST = "http://192.168.1.46:4000/subpub/";

#define MQTT_SERVER_HOST "192.168.1.46"
...
{
    float value = (*this->doc_)[key];
    return value;
}

uint8_t SIOT::digitalRead(char *key)
{
    uint8_t value = (*this->doc_)[key];
    return value;
}
